 ...
 * @param {(rowId: string, field: keyof DataTableData, value: string | number | undefined, rowData: DataTableData) => void} [viewContentFormatter]            - Formats a value in input view mode according to the given formatter
