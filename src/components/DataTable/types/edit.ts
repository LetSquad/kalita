 ...
 * @param {(value: string | number | undefined) => void} [viewContentFormatter]                                                                               - Formats a value in input view mode according to the given formatter
...
export interface InputEditParams {
    ...
    viewContentFormatter?: (value: string | number | undefined) => void;
    onCellChange?: (
        rowId: string,
